...
library(abind)
library(Hmisc)
source("/Users/nth7/PD_Inhibition_DDM/Code/Chahal Versions/corwithtarget.R")
...
alldat<- read.csv("/Users/nth7/Box Sync/DEPENd/Projects/PD_Inhibition_DDM/Data/alldat.csv", header = T)
