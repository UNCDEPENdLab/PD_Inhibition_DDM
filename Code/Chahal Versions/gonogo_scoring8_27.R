...
ge<-ggplot( cmat, aes(x=traits,y=gono,fill=p,label=r) ) + geom_tile() + scale_fill_continuous(high='#000000',low='#FF0000', limits=c(0,.10) ) + geom_text(color=I('white'),size=5)+theme(axis.title.x=element_text(face="bold",colour="Black", size=14),
...
d<-ge+scale_y_discrete(limits=rev((levels=c("MeanGoRT_1",
                                         "sumFalseAlarms_1"))),
