...
In MLR, there is a meaningful cross-loading of P1 onto Inhib. Test this in BSEM, too.
...
Combo_m <- mplusObject(
  TITLE="Aff Extraversion, Antag, Inhib combination",
  DEFINE="
    p1=MEAN(MISTRUST MPS_alR);
    p2=MEAN(PROPER MPS_tdR);
    p3=MEAN(MPS_clR IMPUL);
  ...
  MODEL = "
    ...
    antag inhib affiliat WITH
      antag inhib affiliat;
...
Combo_m <- mplusObject(
  TITLE="Agentic Extraversion, Antag, Inhib combination",
  DEFINE="
    p1=MEAN(MISTRUST MPS_alR);
    p2=MEAN(PROPER MPS_tdR);
    p3=MEAN(MPS_clR IMPUL);
