...
```{r echo = FALSE}
sr.fa.AC <- fa(select(self_reps, IMPUL, PROPER, HDWK, DISINHP, MPS_acR, MPS_clR, MPS_tdR, MPS_agR, AGG, MPS_alR, MANIP, MISTRUST, MPS_haR), 2, rotate="oblimin", fm = "pa")
...
```{r echo = FALSE}
AC_fscores <- factor.scores(select(self_reps, IMPUL, PROPER, HDWK, DISINHP, MPS_acR, MPS_clR, MPS_tdR, MPS_agR, AGG, MPS_alR, MANIP, MISTRUST, MPS_haR), sr.fa.AC$loadings, Phi = sr.fa.AC$Phi, method = "regression")
