...
knitr::opts_knit$set(root.dir = "/Users/natehall/ics/Nate/PD_Inhibition_DDM/")
...
```{r}
# str(flank_acc_trim)
flank_acc_trim <- flank_acc_trim %>% dplyr::rename(`rt` = `TrialSlide_RT`)
...
subject_sd3 <- flank_acc_trim %>% group_by(Subject, Incongruent ) %>% dplyr::summarise(winsorize = unique(con_SD3AHmean_rt_high))
